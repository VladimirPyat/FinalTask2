...
/**
*Класс домашних животных, помимо стандартных полей, наследуемых от суперкласса, содержит
*поля
...
public abstract class PetAnimal extends Animal {
    ...
    public PetAnimal(int id, String type, String birthDate, String name) {
        super(id, type, birthDate, name);                                                        //id назначается в репозитории
        ArrayList<String> commands = new ArrayList<>(List.of("voice", "come", "lay", "stand"));     //список команд для всех животных типа
